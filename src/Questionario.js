...
import Logo from './images/ufal.png'
import Nees from './images/nees.png'
...
function getSteps() {
  return ['Questionário Demográfico', 'Ferramenta de Configuração', 'Resumo do Tutor']
}
...
class Questionario extends Component {
  constructor(props) {
    ...
    this.handleChangeResumo1 = this.handleChangeResumo1.bind(this)
    this.handleChangeResumo2 = this.handleChangeResumo2.bind(this)
    this.handleChangeResumo3 = this.handleChangeResumo3.bind(this)
    this.handleChangeFerramenta1 = this.handleChangeFerramenta1.bind(this)
    this.handleChangeFerramenta2 = this.handleChangeFerramenta2.bind(this)
    this.handleChangeFerramenta3 = this.handleChangeFerramenta3.bind(this)
    this.handleChangeFerramenta4 = this.handleChangeFerramenta4.bind(this)
    this.handleChangeFerramenta5 = this.handleChangeFerramenta5.bind(this)
    this.handleChangeFerramenta6 = this.handleChangeFerramenta6.bind(this)
    this.handleChangeFerramenta7 = this.handleChangeFerramenta7.bind(this)
    this.handleChangeFerramenta8 = this.handleChangeFerramenta8.bind(this)
    this.handleChangeFerramenta9 = this.handleChangeFerramenta9.bind(this)
    this.handleChangeFerramenta10 = this.handleChangeFerramenta10.bind(this)
    this.handleChangeFerramenta11 = this.handleChangeFerramenta11.bind(this)
    this.handleChangeFerramenta12 = this.handleChangeFerramenta12.bind(this)
    this.handleChangeFerramenta13 = this.handleChangeFerramenta13.bind(this)
    this.handleChangeFerramenta14 = this.handleChangeFerramenta14.bind(this)
    this.handleChangeFerramenta15 = this.handleChangeFerramenta15.bind(this)
    this.handleChangeFerramenta16 = this.handleChangeFerramenta16.bind(this)
    this.handleChangeFerramenta17 = this.handleChangeFerramenta17.bind(this)
    this.handleChangeFerramenta18 = this.handleChangeFerramenta18.bind(this)
    this.handleChangeFerramenta19 = this.handleChangeFerramenta19.bind(this)
    this.handleChangeFerramenta20 = this.handleChangeFerramenta20.bind(this)
    this.handleChangeFerramenta21 = this.handleChangeFerramenta21.bind(this)
    this.handleChangeFerramenta22 = this.handleChangeFerramenta22.bind(this)
    this.handleChangeFerramenta23 = this.handleChangeFerramenta23.bind(this)
    this.handleChangeFerramenta24 = this.handleChangeFerramenta24.bind(this)
    this.handleChangeFerramenta25 = this.handleChangeFerramenta25.bind(this)
    this.handleChangeFerramenta26 = this.handleChangeFerramenta26.bind(this)
  }
  ...
  getStepContent(stepIndex) {
    switch (stepIndex) {
      case 0:
        return (
          <Demografico respostas={this.state} onChangeValue={this.handleChange} />
        )
      case 1:
        return (
          <Ferramenta 
