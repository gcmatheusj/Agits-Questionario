    ...
    return (
      <div>
        <Card style={styles.styleCard} >
          <CardContent>
            <Typography variant="display2" component="label" align="center" style={styles.styleText}>
              <strong>Autoria de Sistemas Educacionais Adaptativos</strong>
            </Typography>
            <div align="center">
              <Typography variant="display1" component="label" align="center">
                <strong>Formulário de Consentimento</strong>
              </Typography>
              <br /><div>
            ...
            <Typography variant="headline" gutterBottom align="justify">
          ...
          <CardContent>
            ...
            <div align="center">
              <Button component={Link} to="/questionario" variant="contained" color="primary" disabled={!this.state.checkedA}>
                Continuar
              </Button>
            </div>
          </CardContent>
